...
class YOLO(object):
    _defaults = {
        "model_path": '../keras-yolo3-detection/model_data/pretrain_model.h5',
        "anchors_path": '../keras-yolo3-detection/model_data/yolo_anchors.txt',
        "classes_path": '../keras-yolo3-detection/model_data/coco_classes.txt',
        "score" : 0.3,
        "iou" : 0.45,
